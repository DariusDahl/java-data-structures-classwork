...
public class TestLSQ {
	...
	public static void main(String[] args) {	
		...
		System.out.print("How many elements do you want in the queue? ");
		int num = s.nextInt();
		...
		for(int i = 0; i < num; i++) {
			...
			System.out.println("Person " + (i + 1) + " Age: " + newP.age);
		}
		...
		if(lsq.sizeSpecial()>=lsq.size()/2) {
			...
			System.out.println("Front --> " + lsq.split()[0] + "Rear");
			System.out.println("Queue 2");
			System.out.println("Front --> " + lsq.split()[1] + "Rear");
		}
		else {
